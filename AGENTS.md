...
- Manual walkthrough unit entry is free-text (property/unit/recorded sqft), chosen 2026-08-02 over wiring live Supabase `properties`/`units` so build 11 has no backend dependency; live roster wiring is deferred until after build 11.
