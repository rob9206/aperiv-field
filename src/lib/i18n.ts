...
const en = {
  ...
  listening: 'Listening…',
  voiceHearFailed: 'Could not hear that. Type the note or try again.',
  voiceMicDenied:
    'Microphone is needed. Enable it in Settings, then try again.',
  whatEachRoomNeeds: 'What each room needs',
  closeRoom: 'Close',
  back: 'Back',
  removePhoto: 'Remove',
  addPhoto: 'Add',
...
const es: { [K in keyof typeof en]: string } = {
  ...
  voiceHearFailed: 'No se escuchó. Escribe la nota o inténtalo de nuevo.',
  voiceMicDenied:
    'Se necesita el micrófono. Actívalo en Ajustes e inténtalo de nuevo.',
  whatEachRoomNeeds: 'Lo que necesita cada habitación',
  closeRoom: 'Cerrar',
  back: 'Atrás',
  removePhoto: 'Quitar',
  addPhoto: 'Añadir',
